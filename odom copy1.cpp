...
//         static const float RX_ENC_OFFSET;
//         static const float LX_ENC_OFFSET;
//         static const float Y_ENC_OFFSET;

//         static const float TICKS_PER_ROTATION;
//         static const float WHEEL_CIRCUMFERENCE;
//         static const float TICKS_PER_INCH;
//         static const float DISPLACEMENT_CONSTANT;
...
// const float odom::WHEEL_DIAMETER = 1.36;
// const float odom::RX_ENC_OFFSET = 1.25;
// const float odom::LX_ENC_OFFSET = 1.125;
// const float odom::Y_ENC_OFFSET = 0.375;
// const float odom::TICKS_PER_ROTATION = 8192.0;
// const float odom::WHEEL_CIRCUMFERENCE = odom::WHEEL_DIAMETER * M_PI;
// const float odom::DISPLACEMENT_CONSTANT = WHEEL_CIRCUMFERENCE / TICKS_PER_ROTATION;
...
//     // float imuRaw = 0;
//     // if (odomSensors.vertical1 != nullptr) vertical1Raw = odomSensors.vertical1->getDis/tanceTraveled();
...
//     odom::currentEnc.l_x = odomSensors.vertical1->getRaw();
//     odom::currentEnc.y = odomSensors.horizontal1->getRaw();
//     odom::currentEnc.theta = -degToRad(odomSensors.imu->get_rotation());

//     // Calculate the encoder value change since the last update
//     odom::deltaEnc = odom::currentEnc - odom::lastEnc;
    
//     // Update last encoder values
//     odom::lastEnc = odom::currentEnc;
