...
Arm::Arm(float kP, float kI, float kD, float kP2, float kI2, float kD2) : armMotor(3, pros::MotorGears::red), armRot(9), armLimit({7,8}), large(kP, kI, kD, 0, 0), small(kP2, kI2, kD2, 0, 0) {
